...
public abstract class DatasetGenerator: IDatasetGenerator
{
    protected readonly IList<string> _texts;
    ...
    public DatasetGenerator(Device device, ITokenizer tokenizer, IList<string> texts, int batchSize, int workerNum, int seqLen, int? seed = null)
    {
        this.device = device;
